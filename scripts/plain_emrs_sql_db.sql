...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`patients` (
  ...
  `patient_license_number` VARCHAR(45) NULL,
  `patient_vehicle_serial_number` VARCHAR(45) NULL,
  `patient_vehicle_plate_number` VARCHAR(45) NULL,
  `patient_url` VARCHAR(45) NULL,
  `patient_device_serial_number` VARCHAR(45) NULL,
  `patient_ip_address` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`visits` (
  `visits_id` INT NOT NULL AUTO_INCREMENT,
  `medical_record_id` VARCHAR(85) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`vitals` (
  ...
  `vitals_height` INT NULL,
  `vitals_weight` INT NULL,
  `vitals_calculated_bmi` INT NULL,
  `vitals_temperature` FLOAT NULL,
  `vitals_pulse` INT NULL,
  `vitals_respiratory_rate` INT NULL,
  `vitals_blood_pressure_systolic` INT NULL,
  `vitals_blood_pressure_diastolic` INT NULL,
  `vitals_arterial_blood_oxygen_saturation` INT NULL,
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`blood_relatives` (
  `blood_relative_id` INT NOT NULL AUTO_INCREMENT,
  `medical_record_id` VARCHAR(85) NOT NULL,
