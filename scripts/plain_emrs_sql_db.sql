...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`medical_records` (
  ...
  `users_user_id` VARCHAR(75) NOT NULL,
  ...
  PRIMARY KEY (`medical_record_id`, `users_user_id`),
  UNIQUE INDEX `record_id_UNIQUE` (`medical_record_id` ASC) VISIBLE,
  INDEX `fk_medical_records_users1_idx` (`users_user_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`medication` (
  ...
  PRIMARY KEY (`medication_id`, `medical_record_id`),
