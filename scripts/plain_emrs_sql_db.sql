...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`nonpatients` (
  `nonpatient_id` INT NOT NULL AUTO_INCREMENT,
  `given_name` VARCHAR(50) NOT NULL,
  `middle_name` VARCHAR(50) NOT NULL,
  `last_name` VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`person_staff` (
  ...
  `nonpatient_id` INT NOT NULL,
  PRIMARY KEY (`nonpatient_id`),
  INDEX `fk_person_staff_nonpatients1_idx` (`nonpatient_id` ASC) VISIBLE,
  CONSTRAINT `fk_person_staff_nonpatients1`
    FOREIGN KEY (`nonpatient_id`)
    REFERENCES `plain_emrs`.`nonpatients` (`nonpatient_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`person_staff_doctors` (
  ...
  CONSTRAINT `fk_person_staff_doctors_person_staff1`
    FOREIGN KEY (`nonpatient_id`)
    REFERENCES `plain_emrs`.`person_staff` (`nonpatient_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`staff_wards` (
  `ward_id` INT NOT NULL,
  `nonpatient_id` INT NOT NULL,
  PRIMARY KEY (`ward_id`, `nonpatient_id`),
  INDEX `fk_staff_ward_ward1_idx` (`ward_id` ASC) VISIBLE,
  INDEX `fk_staff_wards_person_staff1_idx` (`nonpatient_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `plain_emrs`.`person_staff_positions` (
  `staff_position_id` INT NOT NULL,
  `nonpatient_id` INT NOT NULL,
  PRIMARY KEY (`staff_position_id`, `nonpatient_id`),
  INDEX `fk_person_staff_positions_person_staff1_idx` (`nonpatient_id` ASC) VISIBLE,
