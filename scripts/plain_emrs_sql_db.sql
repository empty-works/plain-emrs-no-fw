...
START TRANSACTION;
USE `plain_emrs`;
INSERT INTO `plain_emrs`.`users` (`user_name`, `user_password`, `user_email_address`, `user_enabled`, `user_created_on`, `patient_id`, `nonpatient_id`, `current_facility_id`) VALUES ('the_admin', '123', 'the_admin@gmail.com', true, '2021-08-05 21:57:01', NULL, NULL, NULL);
