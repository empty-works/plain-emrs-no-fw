...
-- -----------------------------------------------------
-- Table `plain_emrs`.`users_facilities_settings`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `plain_emrs`.`users_facilities_settings` ;

CREATE TABLE IF NOT EXISTS `plain_emrs`.`users_facilities_settings` (
)
ENGINE = InnoDB;
