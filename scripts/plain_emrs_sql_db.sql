...
-- -----------------------------------------------------
-- Table `plain_emrs`.`hospital_types`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `plain_emrs`.`hospital_types` ;

CREATE TABLE IF NOT EXISTS `plain_emrs`.`hospital_types` (
  `hospital_type_id` VARCHAR(45) NOT NULL,
  `name` VARCHAR(45) NULL,
  `facility_id` VARCHAR(75) NOT NULL,
  PRIMARY KEY (`hospital_type_id`, `facility_id`),
